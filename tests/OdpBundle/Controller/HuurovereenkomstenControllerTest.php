...
class HuurovereenkomstenControllerTest extends WebTestCase
{
    public function testSortColumns()
    {
        $medewerker = $this->getContainer()->get('AppBundle\Service\MedewerkerDao')->find('odp_user');
        $this->logIn($medewerker);

        $crawler = $this->client->request('GET', '/odp/huurovereenkomsten/');
