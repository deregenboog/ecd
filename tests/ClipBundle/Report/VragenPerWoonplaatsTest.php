...
use ClipBundle\Report\VragenPerWoonplaats;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerWoonplaatsTest extends TestCase
{
    public function testReport()
    {
        ...
        $report = new VragenPerWoonplaats($vraagDao, $contactmomentenDao);
