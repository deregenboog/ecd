...
use ClipBundle\Report\VragenPerHulpvrager;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerHulpvragerTest extends TestCase
{
    public function testReport()
    {
        ...
        $report = new VragenPerHulpvrager($vraagDao, $contactmomentenDao);
