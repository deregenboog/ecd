...
use ClipBundle\Report\VragenPerCommunicatiekanaal;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerCommunicatiekanaalTest extends TestCase
{
    public function testReport()
    {
        ...
        $vraagDao->expects($this->once())
            ->method('countByCommunicatiekanaal')
        ...
        $report = new VragenPerCommunicatiekanaal($vraagDao, $contactmomentenDao);
