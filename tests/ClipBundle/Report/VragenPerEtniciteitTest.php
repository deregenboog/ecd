...
use ClipBundle\Report\VragenPerEtniciteit;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerEtniciteitTest extends TestCase
{
    public function testReport()
    {
        ...
        $report = new VragenPerEtniciteit($vraagDao, $contactmomentenDao);
