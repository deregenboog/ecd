...
use ClipBundle\Report\VragenPerLeeftijdscategorie;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerLeeftijdscategorieTest extends TestCase
{
    public function testReport()
    {
        ...
        $vraagDao->expects($this->once())
            ->method('countByLeeftijdscategorie')
        ...
        $report = new VragenPerLeeftijdscategorie($vraagDao, $contactmomentenDao);
        ...
        $expected = [
            [
                'title' => '',
                'xDescription' => '',
                'yDescription' => 'Leeftijdscategorie',
                'data' => [
                    'E-mail' => [
                        'Contactmomenten' => 212,
                        'Vragen' => 12,
