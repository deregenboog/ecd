...
use ClipBundle\Report\VragenPerViacategorie;
use ClipBundle\Service\ContactmomentDaoInterface;
use ClipBundle\Service\VraagDaoInterface;
use PHPUnit\Framework\TestCase;

class VragenPerViacategorieTest extends TestCase
{
    public function testReport()
    {
        ...
        $report = new VragenPerViacategorie($vraagDao, $contactmomentenDao);
