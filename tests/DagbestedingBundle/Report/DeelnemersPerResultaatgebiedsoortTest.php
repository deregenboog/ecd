...
use DagbestedingBundle\Report\DeelnemersPerResultaatgebiedsoort;
use DagbestedingBundle\Service\DeelnemerDaoInterface;
use PHPUnit\Framework\TestCase;

class DeelnemersPerResultaatgebiedsoortTest extends TestCase
{
    public function testReport()
    {
        ...
        $dagdeelDao->expects($this->exactly(4))
            ->method('countByResultaatgebiedsoort')
            ->withConsecutive(
        ...
        $report = new DeelnemersPerResultaatgebiedsoort($dagdeelDao);
