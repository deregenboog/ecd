...
use DagbestedingBundle\Report\DeelnemersZonderVOG;
use DagbestedingBundle\Service\DeelnemerDaoInterface;
use PHPUnit\Framework\TestCase;

class DeelnemersZonderVOGTest extends TestCase
{
    public function testReport()
    {
        ...
        $report = new DeelnemersZonderVOG($dagdeelDao);
