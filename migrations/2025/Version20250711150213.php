 ...
 */
final class Version20250711150213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("
            ...
            SELECT 
                NULL, 
                (SELECT id FROM `locaties` WHERE naam = 'Nachtopvang Amoc West'), 
                dagen.dag_nummer, 
                '10:00', 
                '16:30', 
                CURRENT_TIMESTAMP, 
