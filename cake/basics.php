...
if (!function_exists('clone')) {
     ...
     * @return bool Success
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#config
     */
    function config()
    {
        $args = func_get_args();
        foreach ($args as $arg) {
            if ('database' === $arg && file_exists(CONFIGS.'database.php')) {
     ...
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#uses
     */
    function uses()
    {
        $args = func_get_args();
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#debug
     */
...
if (!function_exists('array_combine')) {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#h
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#a
     * @deprecated Will be removed in 2.0
     */
    function a()
    {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#aa
     * @deprecated Will be removed in 2.0
     */
    function aa()
    {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#e
     * @deprecated Will be removed in 2.0
     */
    function e($text)
    {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#low
     * @deprecated Will be removed in 2.0
     */
    function low($str)
    {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#up
     * @deprecated Will be removed in 2.0
     */
    function up($str)
    {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#r
     * @deprecated Will be removed in 2.0
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#pr
     */
    function pr($var)
    {
        if (Configure::read() > 0) {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#am
     */
    function am()
    {
        $r = [];
    ...
    function env($key)
    {
        if ('HTTPS' == $key) {
            ...
            return 0 === strpos(env('SCRIPT_URI'), 'https://');
        }
        ...
        if (isset($_SERVER[$key])) {
            ...
            $val = $_ENV[$key];
        } elseif (false !== getenv($key)) {
            $val = getenv($key);
        }

        if ('REMOTE_ADDR' === $key && $val === env('SERVER_ADDR')) {
...
if (!function_exists('file_put_contents')) {
    ...
    function cache($path, $data = null, $expires = '+1 day', $target = 'cache')
    {
        ...
        if (null === $data) {
            if (file_exists($filename) && false !== $filetime) {
    ...
    {
        if (is_string($params) || null === $params) {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#stripslashes_deep
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#__
     */
 ...
 */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#fileExistsInPath
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#convertSlash
     */
 ...
 */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Global-Constants-and-Functions.html#ife
     * @deprecated Will be removed in 2.0
     */
