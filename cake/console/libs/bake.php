 ...
 *
 * @see          http://book.cakephp.org/1.3/en/The-Manual/Core-Console-Applications/Code-Generation-with-Bake.html
 */
class BakeShell extends Shell
{
    ...
    public function main()
    {
        ...
        $classToBake = strtoupper($this->in(__('What would you like to Bake?', true), ['D', 'M', 'V', 'C', 'P', 'F', 'T', 'Q']));
        switch ($classToBake) {
            case 'D':
    ...
    public function all()
    {
        ...
        if ($modelBaked && false === $modelExists) {
