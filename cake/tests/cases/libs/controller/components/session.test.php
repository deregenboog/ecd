...
class SessionComponentTest extends CakeTestCase
{
     ...
     */
    public function testSessionActivate()
    {
        $Session = new SessionComponent();
    ...
    public function testSessionReadWrite()
    {
        ...
        $this->assertEqual($Session->read('Test.key'), ['path' => 'some value', 'path2' => 'another value']);
        $Session->delete('Test');
    ...
    public function testSessionFlash()
    {
        ...
        $this->assertEqual($Session->read('Message.flash'), ['message' => 'This is a test message', 'element' => 'default', 'params' => []]);

        $Session->setFlash('This is a test message', 'test', ['name' => 'Joel Moss']);
        $this->assertEqual($Session->read('Message.flash'), ['message' => 'This is a test message', 'element' => 'test', 'params' => ['name' => 'Joel Moss']]);

        $Session->setFlash('This is a test message', 'default', [], 'myFlash');
        $this->assertEqual($Session->read('Message.myFlash'), ['message' => 'This is a test message', 'element' => 'default', 'params' => []]);
