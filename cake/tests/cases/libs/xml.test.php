...
class XmlTest extends CakeTestCase
{
     ...
     */
    public function testRootTagParsing()
    {
    ...
    public function testSerialization()
    {
        $input = [
            [
                'Project' => ['id' => 1, 'title' => null, 'client_id' => 1, 'show' => 1, 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => 1, 'industry_id' => 1, 'modified' => null, 'created' => null],
                'Style' => ['id' => null, 'name' => null],
                'JobType' => ['id' => 1, 'name' => 'Touch Screen Kiosk'],
                'Industry' => ['id' => 1, 'name' => 'Financial'],
            ],
            [
                'Project' => ['id' => 2, 'title' => null, 'client_id' => 2, 'show' => 1, 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => 2, 'industry_id' => 2, 'modified' => '2007-11-26 14:48:36', 'created' => null],
                'Style' => ['id' => null, 'name' => null],
                'JobType' => ['id' => 2, 'name' => 'Awareness Campaign'],
                'Industry' => ['id' => 2, 'name' => 'Education'],
            ],
        ];
    ...
    public function testSerializeOnMultiDimensionalArray()
    {
        ...
        $result = new Xml($data, ['format' => 'tags']);
     ...
     */
    public function testSerializeCapsWithoutSlug()
    {
        $data = [
            'USERS' => [
                ['USER' => ['ID' => 1]],
        ...
        $result = new Xml($data, ['format' => 'tags', 'slug' => false]);
    ...
    {
        $xml = new Xml(['hello' => 'world'], ['format' => 'tags']);
     ...
     */
    public function testSimpleArrayWithZeroValues()
    {
        $xml = new Xml(['zero_string' => '0', 'zero_integer' => 0], ['format' => 'tags']);
        ...
        $xml = new Xml($data, ['format' => 'tags']);
        $result = $xml->toString(['format' => 'tags', 'header' => false]);
    ...
    public function testHeader()
    {
        ...
        $result = $xml->toString(['header' => true]);
     ...
     */
    public function testArraySingleSerialization()
    {
        $input = [
            'Post' => [
     ...
     */
    public function testSerializationArray()
    {
        $input = [
            [
                'Project' => ['id' => 1, 'title' => null, 'client_id' => 1, 'show' => 1, 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => 1, 'industry_id' => 1, 'modified' => null, 'created' => null],
        ...
        $xml = new Xml($input, ['format' => 'tags']);
        $result = $xml->toString(['header' => false, 'cdata' => false]);
        $this->assertEqual($expected, $result);
    }
     ...
     */
    public function testSerializationNestedArray()
    {
        $input = [
            [
                'Project' => ['id' => 1, 'title' => null, 'client_id' => 1, 'show' => 1, 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => 1, 'industry_id' => 1, 'modified' => null, 'created' => null],
                ...
                'JobType' => ['id' => 1, 'name' => 'Touch Screen Kiosk'],
                'Industry' => ['id' => 1, 'name' => 'Financial'],
                'BusinessSolution' => [['id' => 6, 'name' => 'Convert Sales']],
                'MediaType' => [
                    ['id' => 15, 'name' => 'Print'],
                    ['id' => 7, 'name' => 'Web Demo'],
                    ['id' => 6, 'name' => 'CD-ROM'],
            ...
            [
                ...
                'Industry' => ['id' => 2, 'name' => 'Education'],
                'BusinessSolution' => [
                    ['id' => 4, 'name' => 'Build Relationship'],
                    ['id' => 6, 'name' => 'Convert Sales'],
                ],
                'MediaType' => [
                    ['id' => 17, 'name' => 'Web'],
                    ['id' => 6, 'name' => 'CD-ROM'],
     ...
     * as expected.
     *
     * @see   https://trac.cakephp.org/ticket/6294
     */
    public function testArraySerializationWithRoot()
    {
        $input = [
            ['Shirt' => ['id' => 1, 'color' => 'green']],
            ['Shirt' => ['id' => 2, 'color' => 'blue']],
        ];
        $expected = '<collection><shirt id="1" color="green" />';
        $expected .= '<shirt id="2" color="blue" /></collection>';

        $Xml = new Xml($input, ['root' => 'collection']);
        $result = $Xml->toString(['header' => false]);
        $this->assertEqual($expected, $result);
    }
    ...
    public function testNextSibling()
    {
        $input = [
            [
                'Project' => ['id' => 1, 'title' => null, 'client_id' => 1, 'show' => '1', 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => '1.89', 'industry_id' => '1.56', 'modified' => null, 'created' => null],
                'Style' => ['id' => null, 'name' => null],
                'JobType' => ['id' => 1, 'name' => 'Touch Screen Kiosk'],
                'Industry' => ['id' => 1, 'name' => 'Financial'],
            ],
            [
                'Project' => ['id' => 2, 'title' => null, 'client_id' => 2, 'show' => '1', 'is_spotlight' => null, 'style_id' => 0, 'job_type_id' => '2.2', 'industry_id' => 2.2, 'modified' => '2007-11-26 14:48:36', 'created' => null],
                'Style' => ['id' => null, 'name' => null],
                'JobType' => ['id' => 2, 'name' => 'Awareness Campaign'],
                'Industry' => ['id' => 2, 'name' => 'Education'],
            ],
     ...
     */
    public function testAddAndRemoveAttributes()
    {
     ...
     */
    public function testParsingWithNonStandardWhitespace()
    {
        $raw = '<?xml version="1.0" encoding="ISO-8859-1" ?><prices><price>1.0</price></prices>';
        $array = ['Prices' => ['price' => 1.0]];
    ...
    public function testAllCData()
    {
        ...
        $xml = new Xml($input, ['format' => 'tags']);
        $result = $xml->toString(['header' => false, 'cdata' => true]);
        $this->assertEqual($expected, $result);
    }
    ...
    public function testWhitespace()
    {
        ...
        $xml = new Xml($input, ['format' => 'tags']);
        $result = $xml->toString(['header' => false, 'cdata' => false, 'whitespace' => true]);
        $this->assertEqual($expected, $result);
    }
    ...
    public function testSetSerialization()
    {
        ...
        $xml = new Xml(Set::map($input), ['format' => 'tags']);
        $result = $xml->toString(['header' => false, 'cdata' => false]);
        $this->assertEqual($expected, $result);
    }
     ...
     */
    public function testNormalizeNotAdding_name_Element()
    {
        $input = [
            'output' => [
                'Vouchers' => [
        ...
        $xml = new Xml($input, ['attributes' => false, 'format' => 'tags']);
     ...
     */
    public function testElementCollapsing()
    {
     ...
     */
    public function testCaseFoldingWithEmptyValues()
    {
     ...
     */
    public function testMixedParsing()
    {
    ...
    public function testComplexParsing()
    {
        ...
        $xml = new Xml($source);
        $result = $xml->toString(['cdata' => false]);
        $this->assertEqual($source, $result);
    }
     ...
     */
    public function testEscapeCharSerialization()
    {
        $xml = new Xml(['text' => 'JavaScript & DHTML'], ['attributes' => false, 'format' => 'attributes']);
     ...
     */
    public function testCompleteEscapeCharSerialization()
    {
        $xml = new Xml(['text' => '<>&"\''], ['attributes' => false, 'format' => 'attributes']);
    ...
    public function testToArray()
    {
        ...
        $expected = [
            'Main' => [
                'First' => [
                    ['label' => 'first type node 1'],
                    ['label' => 'first type node 2'],
                ],
                'Second' => ['label' => 'second type node'],
            ],
        ];
        $this->assertIdentical($result, $expected);
        ...
        $expected = [
            'Main' => [
                ...
                'Second' => ['label' => 'second type node'],
                'Collection' => [
                    'Fifth' => ['label' => 'fifth type node'],
                    'Third' => [
                        ['label' => 'third type node 1'],
                        ['label' => 'third type node 2'],
                        ['label' => 'third type node 3'],
                    ],
                    'Fourth' => ['label' => 'fourth type node'],
                ],
            ],
        ];
        $this->assertIdentical($result, $expected);
     ...
     */
    public function testNumericDataHandling()
    {
     ...
     */
    public function testMemoryLeakInConstructor()
    {
     ...
     */
    public function testToArrayAlternate()
    {
        $sXml =
        '<t1>
		 	<t2>A</t2>
    ...
    <foo name="qa" profile-id="Default" />
        ...
        $expected = [
            'Stuff' => [
                'Foo' => [
                    ['name' => 'abc-16', 'profile-id' => 'Default'],
                    ['name' => 'abc-17', 'profile-id' => 'Default',
                        'Bar' => ['id' => 'HelloWorld'], ],
                    ['name' => 'abc-asdf', 'profile-id' => 'Default'],
                    ['name' => 'cba-1A', 'profile-id' => 'Default',
                        'Bar' => ['id' => 'Baz'], ],
                    ['name' => 'cba-2A', 'profile-id' => 'Default',
                        'Bar' => ['id' => 'Baz'], ],
                    ['name' => 'qa', 'profile-id' => 'Default'],
                ],
            ],
        ];
        $this->assertIdentical($result, $expected);
  ...
  <node name="third" />
    ...
    public function testToStringSlugging()
    {
        $array = [
            'Response' => [
                'OneKey' => 'foo',
