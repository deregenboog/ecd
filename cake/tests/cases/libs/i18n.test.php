...
class I18nTest extends CakeTestCase
{
     ...
     * Singular method.
     */
    public function __domainCategorySingular($domain = 'test_plugin', $category = 3)
    {
     ...
     * Plural method.
     */
    public function __domainCategoryPlural($domain = 'test_plugin', $category = 3)
    {
        $plurals = [];
     ...
     * Singular method.
     */
    public function __domainSingular($domain = 'test_plugin')
    {
     ...
     * Plural method.
     */
    public function __domainPlural($domain = 'test_plugin')
    {
        $plurals = [];
        for ($number = 0; $number <= 25; ++$number) {
     ...
     * category method.
     */
    public function __category($category = 3)
    {
     ...
     */
    public function __singularFromCore()
    {
     ...
     */
    public function __pluralFromCore()
    {
        $plurals = [];
        for ($number = 0; $number <= 25; ++$number) {
