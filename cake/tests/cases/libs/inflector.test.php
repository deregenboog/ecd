...
class InflectorTest extends CakeTestCase
{
    ...
    {
        $result = Inflector::slug('replace every r', ['/r/' => '1']);
        $expected = '1eplace_eve1y_1';
        $this->assertEqual($result, $expected);

        $result = Inflector::slug('replace every r', '_', ['/r/' => '1']);
        $expected = '1eplace_eve1y_1';
        $this->assertEqual($result, $expected);
    }
    ...
    {
        $result = Inflector::slug('Testing æ ø å', '-', ['/å/' => 'aa', '/ø/' => 'oe']);
     ...
     */
    public function testRulesNoErrorPHP4()
    {
    ...
    public function testCustomTransliterationRule()
    {
        ...
        $this->assertEqual(Inflector::slug('Testing æ ø å', '-', ['/ø/' => 'oe']), 'Testing-ae-oe-aa');
    }
