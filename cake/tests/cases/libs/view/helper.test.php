...
class HelperTest extends CakeTestCase
{
    ...
    public function testSetEntity()
    {
        ...
        $this->assertEqual($this->View->entity(), ['HelperTestPost', 5, 'id']);
        ...
        $this->assertEqual($this->View->entity(), ['HelperTestPost', 0, 'id']);
    ...
    public function testValue()
    {
        ...
        $this->Helper->data = ['HelperTestTag' => ['HelperTestTag' => '']];
        $this->Helper->setEntity('HelperTestTag.HelperTestTag');
        $result = $this->Helper->value('HelperTestTag.HelperTestTag');
        $this->assertEqual($result, '');

        $this->Helper->data = ['HelperTestTag' => ['HelperTestTag' => [2, 3, 4]]];
        $this->Helper->setEntity('HelperTestTag.HelperTestTag');
        $result = $this->Helper->value('HelperTestTag.HelperTestTag');
        $this->assertEqual($result, [2, 3, 4]);
        ...
        $this->Helper->setEntity('HelperTestTag.HelperTestTag');
        $result = $this->Helper->value('HelperTestTag.HelperTestTag');
        $this->assertEqual($result, [3 => 3, 5 => 5]);

        $this->Helper->data = ['zero' => 0];
        $this->Helper->setEntity('zero');
        $result = $this->Helper->value(['default' => 'something'], 'zero');
        $this->assertEqual($result, ['value' => 0]);
        ...
        $this->assertEqual($result, ['value' => 'something']);
    }
    ...
    public function testClean()
    {
        ...
        $this->assertEqual($result, ['with something', 'something else']);
