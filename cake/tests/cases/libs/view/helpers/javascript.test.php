 ...
 */
App::import('Core', ['Controller', 'View', 'ClassRegistry', 'View']);
App::import('Helper', ['Javascript', 'Html', 'Form']);
...
class JavascriptTest extends CakeTestCase
{
    ...
    {
        $Javascript = new JavascriptHelper(['safe']);
        $this->assertTrue($Javascript->safe);

        $Javascript = new JavascriptHelper(['safe' => false]);
    ...
    public function testLink()
    {
        ...
        $result = $this->Javascript->link(['prototype.js', 'scriptaculous.js']);
     ...
     */
    public function testFilteringAndTimestamping()
    {
    ...
    {
        $result = $this->Javascript->value(['title' => 'New thing', 'indexes' => [5, 6, 7, 8]]);
    ...
    public function testObjectGeneration()
    {
        ...
        $result = $this->Javascript->object(['default' => 0]);
        $expected = '{"default":0}';
        $this->assertEqual($result, $expected);

        $result = $this->Javascript->object([
            '2007' => [
                'Spring' => ['1' => ['id' => 1, 'name' => 'Josh'], '2' => ['id' => 2, 'name' => 'Becky']],
                'Fall' => ['1' => ['id' => 1, 'name' => 'Josh'], '2' => ['id' => 2, 'name' => 'Becky']],
            ], '2006' => [
                'Spring' => ['1' => ['id' => 1, 'name' => 'Josh'], '2' => ['id' => 2, 'name' => 'Becky']],
                'Fall' => ['1' => ['id' => 1, 'name' => 'Josh'], '2' => ['id' => 2, 'name' => 'Becky'],
            ], ],
        ...
        if (ini_get('precision') >= 12) {
            ...
            $result = $this->Javascript->object(['Object' => [true, false, 1, '02101', 0, -1, 3.141592653589, '1']]);
            $expected = '{"Object":[true,false,1,"02101",0,-1,'.$number.',"1"]}';
            $this->assertEqual($result, $expected);

            $result = $this->Javascript->object(['Object' => [true => true, false, -3.141592653589, -10]]);
        ...
        $object = ['title' => 'New thing', 'indexes' => [5, 6, 7, 8]];
        $result = $this->Javascript->object($object, ['block' => true]);
        $expected = [
        ...
        $object = ['title' => 'New thing', 'indexes' => [5, 6, 7, 8], 'object' => ['inner' => ['value' => 1]]];
        $result = $this->Javascript->object($object, ['prefix' => 'PREFIX', 'postfix' => 'POSTFIX']);
     ...
     */
    public function testObjectNonNative()
    {
        ...
        $result = $this->Javascript->object($object, ['quoteKeys' => false, 'stringKeys' => ['key1', 'key3']]);
        $this->assertEqual($result, $expected);

        $expected = '{?Object?:{?key1?:"val1",?key2?:"val2",?key3?:"val3"}}';
        $result = $this->Javascript->object($object, ['q' => '?']);
        $this->assertEqual($result, $expected);

        $expected = '{?Object?:{?key1?:"val1",?key2?:val2,?key3?:"val3"}}';
        $result = $this->Javascript->object($object, [
            'q' => '?', 'stringKeys' => ['key3', 'key1'],
        ]);
        $this->assertEqual($result, $expected);

        $expected = '{?Object?:{?key1?:val1,?key2?:"val2",?key3?:val3}}';
        $result = $this->Javascript->object($object, [
            'q' => '?', 'stringKeys' => ['key3', 'key1'], 'quoteKeys' => false,
        ]);
        $this->assertEqual($result, $expected);
    ...
    public function testScriptBlock()
    {
        ...
        $result = $this->Javascript->codeBlock('something', ['allowCache' => true, 'safe' => false]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            'something',
            '/script',
        ...
        $result = $this->Javascript->codeBlock('something', ['allowCache' => false, 'safe' => false]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            'something',
            '/script',
        ...
        $result = $this->Javascript->codeBlock('something', ['safe' => false]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            'something',
            '/script',
        ...
        $result = $this->Javascript->codeBlock('something', ['safe' => true]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            $this->cDataStart,
            'something',
        ...
        $result = $this->Javascript->codeBlock(null, ['safe' => true, 'allowCache' => false]);
        $this->assertNull($result);
     ...
     */
    public function testOutOfLineScriptWriting()
    {
        echo $this->Javascript->codeBlock('$(document).ready(function() { });', ['inline' => false]);

        $this->Javascript->codeBlock(null, ['inline' => false]);
        echo '$(function(){ });';
    ...
    public function testEvent()
    {
        ...
        $result = $this->Javascript->event('myId', 'click', 'something();', ['safe' => false]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            "Event.observe($('myId'), 'click', function(event) { something(); }, false);",
            '/script',
        ...
        $result = $this->Javascript->event('myId', 'click', 'something();', ['useCapture' => true]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
            $this->cDataStart,
        ...
        $result = $this->Javascript->event('\'document\'', 'load', 'something();', ['safe' => false]);
        $expected = [
            'script' => ['type' => 'text/javascript'],
     ...
     */
    public function testEscapeScript()
    {
     ...
     */
    public function testStringJsonEncodeCompliance()
    {
     ...
     */
    public function testObjectDecodeCompatibility()
    {
