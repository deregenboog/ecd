...
class DispatcherTest extends CakeTestCase
{
    ...
    public function testMissingController()
    {
        ...
        $controller = $Dispatcher->dispatch($url, ['return' => 1]);
    ...
    public function testDispatchWithArray()
    {
        ...
        $controller = $Dispatcher->dispatch($url, [
            'pass' => ['home'],
            'named' => ['param' => 'value', 'param2' => 'value2'],
            'return' => 1,
        ]);
        $expected = 'Pages';
        $this->assertEqual($expected, $controller->name);
     ...
     */
    public function testDispatchWithGarbageUrl()
    {
        Configure::write('App.baseUrl', '/index.php');
    ...
    public function testAdminDispatch()
    {
        ...
        $this->assertIdentical($controller->passedArgs, ['param' => 'value', 'param2' => 'value2']);
    ...
    public function testPluginDispatch()
    {
        ...
        $expected = [
            ...
            'url' => ['url' => 'my_plugin/some_pages/home/param:value/param2:value2'],
        ];
        ksort($expected);
        ksort($result);
        ...
        $this->assertIdentical($controller->passedArgs, ['0' => 'home', 'param' => 'value', 'param2' => 'value2']);
    ...
    public function testAutomaticPluginControllerDispatch()
    {
        ...
        $this->assertEqual($controller->params['named'], ['param' => 'value', 'param2' => 'value2']);
        ...
        $this->assertEqual($controller->params['pass'], [5]);
        $this->assertEqual($controller->params['named'], ['param' => 'value', 'param2' => 'value2']);
        $this->assertIdentical($controller->plugin, 'my_plugin');
        $this->assertIdentical($controller->name, 'MyPlugin');
        ...
        $controller = $Dispatcher->dispatch('admin/articles_test', ['return' => 1]);
    ...
    public function testPrefixProtection()
    {
        ...
        Router::reload();
        Router::connect('/admin/:controller/:action/*', ['prefix' => 'admin'], ['controller', 'action']);
    ...
    public function testTestPluginDispatch()
    {
        ...
        $url = '/test_plugin/tests/index';
        $result = $Dispatcher->dispatch($url, ['return' => 1]);
    ...
    public function testAssets()
    {
        ...
        App::build([
            'plugins' => [TEST_CAKE_CORE_INCLUDE_PATH.'tests'.DS.'test_app'.DS.'plugins'.DS],
            'vendors' => [TEST_CAKE_CORE_INCLUDE_PATH.'tests'.DS.'test_app'.DS.'vendors'.DS],
     ...
     */
    public function testCachedRegisteringViewObject()
    {
        Configure::write('Cache.disable', false);
        Configure::write('Cache.check', true);
        Configure::write('debug', 2);
    ...
    public function testHttpMethodOverrides()
    {
        ...
        $expected = ['pass' => [], 'named' => [], 'plugin' => null, 'controller' => 'posts', 'action' => 'add', '[method]' => 'POST', 'form' => [], 'url' => []];
        $this->assertEqual($result, $expected);
        ...
        $expected = ['pass' => ['5'], 'named' => [], 'id' => '5', 'plugin' => null, 'controller' => 'posts', 'action' => 'edit', '[method]' => 'PUT', 'form' => [], 'url' => []];
        $this->assertEqual($result, $expected);
        ...
        $result = $dispatcher->parseParams('/posts/5');
        $expected = ['pass' => ['5'], 'named' => [], 'id' => '5', 'plugin' => null, 'controller' => 'posts', 'action' => 'view', '[method]' => 'GET', 'form' => [], 'url' => []];
        $this->assertEqual($result, $expected);
        ...
        $expected = [
            ...
            '[method]' => 'POST', 'form' => ['extra' => 'data'], 'data' => ['Post' => ['title' => 'New Post']],
            'url' => [],
        ];
        $this->assertEqual($result, $expected);
    ...
    public function testEnvironmentDetection()
    {
        ...
        $environments = [
            'IIS' => [
                'No rewrite base path' => [
                    'App' => ['base' => false, 'baseUrl' => '/index.php?', 'server' => 'IIS'],
                    'SERVER' => ['HTTPS' => 'off', 'SCRIPT_NAME' => '/index.php', 'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot', 'QUERY_STRING' => '', 'REMOTE_ADDR' => '127.0.0.1', 'REMOTE_HOST' => '127.0.0.1', 'REQUEST_METHOD' => 'GET', 'SERVER_NAME' => 'localhost', 'SERVER_PORT' => '80', 'SERVER_PROTOCOL' => 'HTTP/1.1', 'APPL_PHYSICAL_PATH' => 'C:\\Inetpub\\wwwroot\\', 'REQUEST_URI' => '/index.php', 'URL' => '/index.php', 'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\index.php', 'ORIG_PATH_INFO' => '/index.php', 'PATH_INFO' => '', 'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\index.php', 'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot', 'PHP_SELF' => '/index.php', 'HTTP_HOST' => 'localhost', 'argv' => [], 'argc' => 0],
                    'reload' => true,
                    'path' => '',
                ],
                'No rewrite with path' => [
                    'SERVER' => ['QUERY_STRING' => '/posts/add', 'REQUEST_URI' => '/index.php?/posts/add', 'URL' => '/index.php?/posts/add', 'argv' => ['/posts/add'], 'argc' => 1],
                    'reload' => false,
                    'path' => '/posts/add',
                ],
                'No rewrite sub dir 1' => [
                    'GET' => [],
                    'SERVER' => ['QUERY_STRING' => '',  'REQUEST_URI' => '/index.php', 'URL' => '/index.php', 'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\index.php', 'ORIG_PATH_INFO' => '/index.php', 'PATH_INFO' => '', 'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\index.php', 'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot', 'PHP_SELF' => '/index.php', 'argv' => [], 'argc' => 0],
                    'reload' => false,
                    'path' => '',
                ],
                'No rewrite sub dir 1 with path' => [
                    'GET' => ['/posts/add' => ''],
                    'SERVER' => ['QUERY_STRING' => '/posts/add', 'REQUEST_URI' => '/index.php?/posts/add', 'URL' => '/index.php?/posts/add', 'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\index.php', 'argv' => ['/posts/add'], 'argc' => 1],
                    'reload' => false,
                    'path' => '/posts/add',
                ],
                'No rewrite sub dir 2' => [
                    'App' => ['base' => false, 'baseUrl' => '/site/index.php?', 'dir' => 'app', 'webroot' => 'webroot', 'server' => 'IIS'],
                    'GET' => [],
                    'POST' => [],
                    'SERVER' => ['SCRIPT_NAME' => '/site/index.php', 'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot', 'QUERY_STRING' => '', 'REQUEST_URI' => '/site/index.php', 'URL' => '/site/index.php', 'SCRIPT_FILENAME' => 'C:\\Inetpub\\wwwroot\\site\\index.php', 'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot', 'PHP_SELF' => '/site/index.php', 'argv' => [], 'argc' => 0],
                    'reload' => false,
                    'path' => '',
                ],
                'No rewrite sub dir 2 with path' => [
                    'GET' => ['/posts/add' => ''],
                    'SERVER' => ['SCRIPT_NAME' => '/site/index.php', 'PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot', 'QUERY_STRING' => '/posts/add', 'REQUEST_URI' => '/site/index.php?/posts/add', 'URL' => '/site/index.php?/posts/add', 'ORIG_PATH_TRANSLATED' => 'C:\\Inetpub\\wwwroot\\site\\index.php', 'DOCUMENT_ROOT' => 'C:\\Inetpub\\wwwroot', 'PHP_SELF' => '/site/index.php', 'argv' => ['/posts/add'], 'argc' => 1],
                    'reload' => false,
                    'path' => '/posts/add',
                ],
            ],
            'Apache' => [
                'No rewrite base path' => [
                    'App' => ['base' => false, 'baseUrl' => '/index.php', 'dir' => 'app', 'webroot' => 'webroot'],
                    'SERVER' => [
                ...
                'GET Request at base domain' => [
                    'App' => ['base' => false, 'baseUrl' => null, 'dir' => 'app', 'webroot' => 'webroot'],
                    'SERVER' => [
                        'HTTP_HOST' => 'cake.1.2',
                    ...
                    'path' => '',
                    'urlParams' => ['a' => 'b'],
                    'environment' => ['CGI_MODE' => false],
                ],
                'New CGI no mod_rewrite' => [
                    'App' => ['base' => false, 'baseUrl' => '/limesurvey20/index.php', 'dir' => 'app', 'webroot' => 'webroot'],
                    'SERVER' => [
        ...
        $this->__loadEnvironment(array_merge(['reload' => true], $backup));
    }
    ...
    public function testTrailingSlash()
    {
        ...
        Router::reload();
        $Dispatcher = new TestDispatcher();
        Router::connect('/myalias/:action/*', ['controller' => 'my_controller', 'action' => null]);
     ...
     */
    public function __backupEnvironment()
    {
        return [
     ...
     */
    public function __reloadEnvironment()
    {
     ...
     * @param mixed $env
     */
    public function __loadEnvironment($env)
    {
        if ($env['reload']) {
            $this->__reloadEnvironment();
        }
     ...
     * @return string
     */
    public function __cachePath($here)
    {
        $path = $here;
        if ('/' == $here) {
            $path = 'home';
