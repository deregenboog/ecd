...
class SchemaShellTest extends CakeTestCase
{
     ...
     * @var array
     */
    public $fixtures = ['core.article', 'core.user', 'core.post', 'core.auth_user', 'core.author',
    ...
    public function testGenerateSnaphot()
    {
        ...
        $this->Shell->Schema->setReturnValue('read', ['schema data']);
        $this->Shell->Schema->setReturnValue('write', true);

        $this->Shell->Schema->expectOnce('read');
        $this->Shell->Schema->expectOnce('write', [['schema data', 'file' => 'schema_1.php']]);
    ...
    public function testGenerateOverwrite()
    {
        ...
        $this->Shell->expectAt(1, 'out', [new PatternExpectation('/Schema file:\s[a-z\.]+\sgenerated/')]);
        $this->Shell->Schema = new MockSchemaCakeSchema();
        $this->Shell->Schema->path = TMP;
        $this->Shell->Schema->setReturnValue('read', ['schema data']);
        $this->Shell->Schema->setReturnValue('write', true);
        ...
        $this->Shell->Schema->expectOnce('read');
        $this->Shell->Schema->expectOnce('write', [['schema data', 'file' => 'schema.php']]);
    ...
    public function testUpdateWithTable()
    {
        ...
        $article = new Model(['name' => 'Article', 'ds' => 'test_suite']);
