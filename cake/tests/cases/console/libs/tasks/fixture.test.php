...
Mock::generatePartial(
    ...
    ['in', 'out', 'err', 'createFile', '_stop', 'getName', 'getTable', 'listAll']
);
...
class FixtureTaskTest extends CakeTestCase
{
     ...
     * @var array
     */
    public $fixtures = ['core.article', 'core.comment', 'core.datatype', 'core.binary_test'];
    ...
    public function testImportRecordsFromDatabaseWithConditions()
    {
        ...
        $result = $this->Task->bake('Article', false, ['fromTable' => true, 'schema' => 'Article', 'records' => false]);
    ...
    public function testExecuteWithNamedModel()
    {
        ...
        $this->Task->expectAt(0, 'createFile', [$filename, new PatternExpectation('/class ArticleFixture/')]);
        $this->Task->execute();
    }
    ...
    public function testExecuteWithNamedModelVariations()
    {
        ...
        $filename = '/my/path/article_fixture.php';
        $this->Task->expectAt(1, 'createFile', [$filename, new PatternExpectation('/class ArticleFixture/')]);
        $this->Task->execute();

        $this->Task->args = ['Articles'];
        $filename = '/my/path/article_fixture.php';
        $this->Task->expectAt(2, 'createFile', [$filename, new PatternExpectation('/class ArticleFixture/')]);
        $this->Task->execute();

        $this->Task->args = ['Article'];
        $filename = '/my/path/article_fixture.php';
        $this->Task->expectAt(3, 'createFile', [$filename, new PatternExpectation('/class ArticleFixture/')]);
        $this->Task->execute();
    }
    ...
    public function testExecuteIntoAll()
    {
        ...
        $this->Task->path = '/my/path/';
        $this->Task->args = ['all'];
        $this->Task->Model->setReturnValue('listAll', ['articles', 'comments']);
        ...
        $this->Task->expectAt(1, 'createFile', [$filename, new PatternExpectation('/class CommentFixture/')]);
        $this->Task->execute();
    }
    ...
    public function testAllWithCountAndRecordsFlags()
    {
        ...
        $filename = '/my/path/article_fixture.php';
        $this->Task->expectAt(0, 'createFile', [$filename, new PatternExpectation('/title\' => \'Third Article\'/')]);

        $filename = '/my/path/comment_fixture.php';
        $this->Task->expectAt(1, 'createFile', [$filename, new PatternExpectation('/comment\' => \'First Comment for First Article/')]);
    ...
    public function testExecuteInteractive()
    {
        ...
        $this->Task->Model->setReturnValue('getTable', 'articles', ['Article']);
    ...
    public function testGenerateFixtureFile()
    {
        ...
        $this->Task->expectAt(0, 'createFile', [$filename, new PatternExpectation('/Article/')]);
        $result = $this->Task->generateFixtureFile('Article', []);

        $this->Task->expectAt(1, 'createFile', [$filename, new PatternExpectation('/\<\?php(.*)$/ms')]);
        $result = $this->Task->generateFixtureFile('Article', []);
    }
