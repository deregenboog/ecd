...
class TestManager
{
     ...
     * @param bool   $testing  Are tests supposed to be auto run.  Set to true to return testcase list.
     *
     * @return mixed
     */
     ...
     * @param bool   $testing      set to true if testing, otherwise test case will be run
     *
     ...
     * @static
     */
    public function addTestCasesFromDirectory(&$groupTest, $directory = '.')
    {
        $manager = new self();
     ...
     * @static
     */
    public function addTestFile(&$groupTest, $file)
    {
        $manager = new self();
     ...
     */
    public function &_getTestCaseList($directory = '.')
    {
     ...
     */
    public function &_getTestFileList($directory = '.')
    {
        $return = $this->_getRecursiveFileList($directory, [&$this, '_isTestCaseFile']);
     ...
     * @static
     */
    public function &getGroupTestList()
    {
        $manager = new self();
     ...
     */
    public function &_getTestGroupFileList($directory = '.')
    {
        $return = $this->_getRecursiveFileList($directory, [&$this, '_isTestGroupFile']);
     ...
     */
    public function &_getTestGroupList($directory = '.')
    {
     ...
     */
    public function &_getGroupTestClassNames($groupTestFile)
    {
        $file = implode("\n", file($groupTestFile));
     ...
     */
    public function &_getRecursiveFileList($directory = '.', $fileTestFunction)
    {
        $fileList = [];
        if (!is_dir($directory)) {
            return $fileList;
     ...
     * @param string $file
     *
     * @return bool whether $file is a test case
     */
    public function _isTestCaseFile($file)
    {
     ...
     * @param string $file
     *
     * @return bool Whether $file is a group
     */
    public function _isTestGroupFile($file)
    {
     ...
     */
    public function _hasExpectedExtension($file, $extension)
    {
     ...
     */
    public function _getTestsPath($type = 'cases')
    {
