...
class CakeTestSuiteDispatcher
{
     ...
     * @var string
     */
    public $_managerClass = 'TestManager';
     ...
     * constructor.
     */
    public function CakeTestSuiteDispatcher()
    {
    ...
    public function dispatch()
    {
        ...
        if ($this->params['group']) {
            ...
            $this->_runTestCase();
        } elseif (isset($_GET['show']) && 'cases' == $_GET['show']) {
            $this->_testCaseList();
        } else {
            $this->_groupTestList();
        }
     ...
     */
    public function _checkSimpleTest()
    {
     ...
     */
    public function _groupTestList()
    {
        $Reporter = &$this->getReporter();
        $Reporter->paintDocumentStart();
        $Reporter->paintTestMenu();
