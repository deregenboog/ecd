 ...
 * Methods to make numbers more readable.
 *
 * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#Number
 */
class NumberHelper extends AppHelper
{
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#precision
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#toReadableSize
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#toPercentage
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#format
     */
    public function format($number, $options = false)
    {
        ...
        $escape = true;
        if (is_array($options)) {
            $options = array_merge(['before' => '$', 'places' => 2, 'thousands' => ',', 'decimals' => '.'], $options);
            extract($options);
        }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Helpers/Number.html#currency
     */
    public function currency($number, $currency = 'USD', $options = [])
    {
