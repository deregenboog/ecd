...
class Scaffold extends Object
{
    ...
    public function __construct(&$controller, $params)
    {
        ...
        $this->_validSession = (
            isset($this->controller->Session) && false != $this->controller->Session->valid()
        );
     ...
     */
    public function __scaffoldView($params)
    {
        if ($this->controller->_beforeScaffold('view')) {
            ...
            $this->_output();
        } elseif (false === $this->controller->_scaffoldError('view')) {
     ...
     */
    public function __scaffoldIndex($params)
    {
        if ($this->controller->_beforeScaffold('index')) {
            ...
            $this->controller->render($this->action, $this->layout);
            $this->_output();
        } elseif (false === $this->controller->_scaffoldError('index')) {
            return $this->__scaffoldError();
        }
    }
     ...
     */
    public function __scaffoldForm($action = 'edit')
    {
     ...
     */
    public function __scaffoldSave($params = [], $action = 'edit')
    {
        $formAction = 'edit';
        ...
        } elseif (false === $this->controller->_scaffoldError($action)) {
            return $this->__scaffoldError();
        }
    }
     ...
     */
    public function __scaffoldDelete($params = [])
    {
        ...
        } elseif (false === $this->controller->_scaffoldError('delete')) {
            return $this->__scaffoldError();
        }
    }
     ...
     */
    public function __scaffoldError()
    {
     ...
     */
    public function __associations()
    {
