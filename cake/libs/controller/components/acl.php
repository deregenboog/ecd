 ...
 *
 * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Access-Control-Lists.html
 */
class AclComponent extends Object
{
     ...
     *
     * @return bool Proceed with component usage (true), or fail (false)
     */
...
class AclBase extends Object
{
    ...
    public function __construct()
    {
        if (0 == strcasecmp(get_class($this), 'AclBase') || !is_subclass_of($this, 'AclBase')) {
...
class DbAcl extends AclBase
{
    ...
    public function __construct()
    {
        ...
        $this->Aro = &ClassRegistry::init(['class' => 'Aro', 'alias' => 'Aro']);
        $this->Aco = &ClassRegistry::init(['class' => 'Aco', 'alias' => 'Aco']);
    }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Access-Control-Lists.html#checking-permissions-the-acl-component
     */
    public function check($aro, $aco, $action = '*')
    {
        if (null == $aro || null == $aco) {
            return false;
        }
        ...
        for ($i = 0; $i < $count; ++$i) {
            ...
            $perms = $this->Aro->Permission->find('all', [
                'conditions' => [
     ...
     * @return bool Success
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Access-Control-Lists.html#assigning-permissions
     */
    public function allow($aro, $aco, $actions = '*', $value = 1)
    {
        ...
        if (null != $perms['link'] && !empty($perms['link'])) {
        ...
        return false !== $this->Aro->Permission->save($save);
    }
    ...
    public function getAclLink($aro, $aco)
    {
        ...
        return [
            ...
            'link' => $this->Aro->Permission->find('all', ['conditions' => [
     ...
     */
    public function _getAcoKeys($keys)
    {
        $newKeys = [];
