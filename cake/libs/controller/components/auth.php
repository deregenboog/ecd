 ...
 */
App::import('Core', ['Router', 'Security'], false);
 ...
 *
 * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html
 */
class AuthComponent extends Object
{
     ...
     * @var object
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#authenticate
     */
     ...
     * @var mixed
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#authorize
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#ajaxLogin
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#userModel
     */
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#userScope
     */
    public $userScope = [];
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#fields
     */
    public $fields = ['username' => 'username', 'password' => 'password'];
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#sessionKey
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#actionPath
     */
     ...
     * @var mixed
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#loginAction
     */
     ...
     * @var mixed
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#loginRedirect
     */
     ...
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#logoutRedirect
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#loginError
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#authError
     */
     ...
     * @var bool
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#autoRedirect
     */
     ...
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#allowedActions
     */
    ...
    public function initialize(&$controller, $settings = [])
    {
        ...
        if (!empty($prefixes)) {
            foreach ($prefixes as $prefix) {
                $this->actionMap = array_merge($this->actionMap, [
                    $prefix.'_index' => 'read',
                    $prefix.'_add' => 'create',
                    $prefix.'_edit' => 'update',
                    $prefix.'_view' => 'read',
    ...
    {
        $isErrorOrTests = (
            'cakeerror' == strtolower($controller->name) ||
            ('tests' == strtolower($controller->name) && Configure::read() > 0)
        );
        if ($isErrorOrTests) {
            return true;
        }
        ...
        if ($loginAction == $url) {
            ...
            if (!$user) {
                if (!$this->RequestHandler->isAjax()) {
                    $this->Session->setFlash($this->authError, $this->flashElement, [], 'auth');
                    if (!empty($controller->params['url']) && count($controller->params['url']) >= 2) {
                        $query = $controller->params['url'];
                        unset($query['url'], $query['ext']);
                        $url .= Router::queryString($query, []);
                    }
     ...
     */
    public function __authType($auth = null)
    {
        if (null == $auth) {
            $auth = $this->authorize;
        }
     ...
     * @param string ... etc.
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#allow
     */
     ...
     *
     * @see AuthComponent::allow()
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#deny
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#mapActions
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#login
     */
     ...
     *
     * @see AuthComponent::$loginAction
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#logout
     */
     ...
     *
     * @see http://book.cakephp.org/view/1264/user
     */
    public function user($key = null)
    {
        ...
        if (null == $key) {
            ...
            return [$model->alias => $this->Session->read($this->sessionKey)];
        } else {
     ...
     *
     * @see http://book.cakephp.org/view/1256/action
     */
    public function action($action = ':plugin/:controller/:action')
    {
        ...
        return str_replace(
            ...
            [Inflector::camelize($this->params['controller']), $this->params['action'], $plugin],
    ...
    public function identify($user = null, $conditions = null)
    {
        ...
        if (is_array($user) && (isset($user[$this->fields['username']]) || isset($user[$model->alias.'.'.$this->fields['username']]))) {
            ...
            $data = $model->find('first', [
                'conditions' => array_merge([$model->escapeField() => $user], $conditions),
            ]);
            if (empty($data) || empty($data[$model->alias])) {
                return null;
            }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#hashPasswords
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Core-Components/Authentication.html#password
     */
