 ...
 *
 * @see          http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Models
 */
class Model extends Overloadable
{
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#useDbConfig-1058
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#useTable-1059
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#displayField-1062
     */
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#data-1065
     */
    public $data = [];
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#primaryKey-1061
     */
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#_schema-1066
     */
    public $_schema = null;
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#validate-1067
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Data-Validation
     */
    public $validate = [];
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Validating-Data-from-the-Controller
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#tablePrefix-1060
     */
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#name-1068
     */
    public $name = null;
     ...
     * @var bool
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#cacheQueries-1069
     */
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#belongsTo
     */
    public $belongsTo = [];
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#hasOne
     */
    public $hasOne = [];
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#hasMany
     */
    public $hasMany = [];
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#hasAndBelongsToMany-HABTM
     */
     ...
     * @var array
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Using-Behaviors
     */
    public $actsAs = null;
     ...
     * @var int
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#recursive-1063
     */
    public $recursive = 1;
     ...
     * @var string
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Model-Attributes#order-1064
     */
    public $order = null;
     ...
     * @var array
     */
    public $__associations = ['belongsTo', 'hasOne', 'hasMany', 'hasAndBelongsToMany'];
    ...
    public function __construct($id = false, $table = null, $ds = null)
    {
        ...
        if (is_subclass_of($this, 'AppModel')) {
            ...
            if (null !== $this->actsAs || false !== $this->actsAs) {
                $merge[] = 'actsAs';
            }
            $parentClass = get_parent_class($this);
            if ('appmodel' !== strtolower($parentClass)) {
        ...
        if (false !== $this->useTable) {
            $this->setDataSource($ds);

            if (null === $this->useTable) {
                $this->useTable = Inflector::tableize($this->name);
            }
            $this->setSource($this->useTable);

            if (null == $this->displayField) {
                $this->displayField = $this->hasField(['title', 'name', $this->primaryKey]);
            }
     ...
     * @return bool Success
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Creating-and-Destroying-Associations-on-the-Fly
     */
    public function bindModel($params, $reset = true)
    {
        foreach ($params as $assoc => $model) {
            if (true === $reset && !isset($this->__backAssociation[$assoc])) {
            ...
            foreach ($model as $key => $value) {
                ...
                if (false === $reset && isset($this->__backAssociation[$assoc])) {
    ...
    public function unbindModel($params, $reset = true)
    {
        foreach ($params as $assoc => $models) {
            ...
            foreach ($models as $model) {
                if (false === $reset && isset($this->__backAssociation[$assoc][$model])) {
    ...
    public function __constructLinkedModel($assoc, $className = null)
    {
        ...
        if (!isset($this->{$assoc}) || $this->{$assoc}->name !== $className) {
            $model = ['class' => $className, 'alias' => $assoc];
            if (PHP5) {
     ...
     */
    public function __generateAssociation($type)
    {
        foreach ($this->{$type} as $assocKey => $assocData) {
            ...
            foreach ($this->__associationKeys[$type] as $key) {
                if (!isset($this->{$type}[$assocKey][$key]) || $this->{$type}[$assocKey][$key] === null) {
                    ...
                    switch ($key) {
                        ...
                        case 'foreignKey':
                            $data = (('belongsTo' == $type) ? Inflector::underscore($assocKey) : Inflector::singularize($this->table)).'_id';
                        break;
            ...
            if (!empty($this->{$type}[$assocKey]['with'])) {
                ...
                $plugin = null;
                if (false !== strpos($joinClass, '.')) {
                    list($plugin, $joinClass) = explode('.', $joinClass);
                    $plugin .= '.';
                    $this->{$type}[$assocKey]['with'] = $joinClass;
                }

                if (!ClassRegistry::isKeySet($joinClass) && true === $dynamicWith) {
                    $this->{$joinClass} = new AppModel([
                        'name' => $joinClass,
                ...
                if (count($this->{$joinClass}->schema()) <= 2 && false !== $this->{$joinClass}->primaryKey) {
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Saving-Your-Data
     */
    public function set($one, $two = null)
    {
        ...
        if (is_array($one)) {
            ...
            if (empty($one[$this->alias])) {
                if (null === $this->getAssociated(key($one))) {
                    $data = [$this->alias => $one];
                }
            }
        } else {
    ...
    public function deconstruct($field, $data)
    {
        ...
        if (in_array($type, ['datetime', 'timestamp', 'date', 'time'])) {
            ...
            if (isset($data['hour']) && isset($data['meridian']) && 12 != $data['hour'] && 'pm' == $data['meridian']) {
                $data['hour'] = $data['hour'] + 12;
            }
            if (isset($data['hour']) && isset($data['meridian']) && 12 == $data['hour'] && 'am' == $data['meridian']) {
                $data['hour'] = '00';
            }
            if ('time' == $type) {
                foreach ($timeFields as $key => $val) {
                    if (!isset($data[$val]) || '0' === $data[$val] || '00' === $data[$val]) {
                        $data[$val] = '00';
                    } elseif ('' === $data[$val]) {
                        $data[$val] = '';
                    } else {
    ...
    {
        if (!is_array($this->_schema) || true === $field) {
            $db = &ConnectionManager::getDataSource($this->useDbConfig);
            $db->cacheSources = ($this->cacheSources && $db->cacheSources);
            if ($db->isInterfaceSupported('describe') && false !== $this->useTable) {
                $this->_schema = $db->describe($this, $field);
            } elseif (false === $this->useTable) {
                $this->_schema = [];
            }
        }
        if (is_string($field)) {
    ...
    public function getColumnType($column)
    {
        ...
        $column = str_replace([$db->startQuote, $db->endQuote], '', $column);
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Retrieving-Your-Data#read-1029
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Retrieving-Your-Data#field-1028
     */
    public function field($name, $conditions = null, $order = null)
    {
        if (null === $conditions && false !== $this->id) {
    ...
    public function saveField($name, $value, $validate = false)
    {
        ...
        if (is_array($validate)) {
            $options = array_merge(['validate' => false, 'fieldList' => [$name]], $validate);
        } else {
    ...
    {
        $defaults = ['validate' => true, 'fieldList' => [], 'callbacks' => true];
        ...
        if (true === $options['callbacks'] || 'before' === $options['callbacks']) {
            $result = $this->Behaviors->trigger($this, 'beforeSave', [$options], [
        ...
        if ($count > 0) {
            ...
            if (!empty($this->id)) {
                ...
                $isUUID = (36 == $fInfo['length'] &&
                    ('string' === $fInfo['type'] || 'binary' === $fInfo['type'])
                );
        ...
        if ($success && $count > 0) {
            ...
            if (true === $options['callbacks'] || 'after' === $options['callbacks']) {
                $this->Behaviors->trigger($this, 'afterSave', [$created, $options]);
     ...
     */
    public function __saveMulti($joined, $id, &$db)
    {
        foreach ($joined as $assoc => $data) {
            if (isset($this->hasAndBelongsToMany[$assoc])) {
                ...
                foreach ((array) $data as $row) {
                    if ((is_string($row) && (36 == strlen($row) || 16 == strlen($row))) || is_numeric($row)) {
                        $values = [
    ...
    public function updateCounterCache($keys = [], $created = false)
    {
        ...
        foreach ($this->belongsTo as $parent => $assoc) {
            ...
            if (!empty($assoc['counterCache'])) {
                ...
                $conditions = (1 == $recursive) ? (array) $assoc['counterScope'] : [];
                ...
                if (isset($keys['old'][$foreignKey])) {
                    if ($keys['old'][$foreignKey] != $keys[$foreignKey]) {
                        ...
                        $this->{$parent}->updateAll(
                            [$assoc['counterCache'] => $count],
                            [$this->{$parent}->escapeField() => $keys['old'][$foreignKey]]
                        );
                    }
                }
                ...
                $this->{$parent}->updateAll(
                    [$assoc['counterCache'] => $count],
                    [$this->{$parent}->escapeField() => $keys[$foreignKey]]
                );
            }
        }
    }
     ...
     */
    public function _prepareUpdateFields($data)
    {
        $foreignKeys = [];
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Saving-Related-Model-Data-hasOne-hasMany-belongsTo
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Saving-Your-Data
     */
    public function saveAll($data = null, $options = [])
    {
        ...
        $options = array_merge(['validate' => 'first', 'atomic' => true], $options);
        $this->validationErrors = $validationErrors = [];
        $validates = true;
        $return = [];

        if (empty($data) && false !== $options['validate']) {
            $result = $this->save($data, $options);

            return !empty($result);
        }

        if ($options['atomic'] && 'only' !== $options['validate']) {
        ...
        if (Set::numeric(array_keys($data))) {
            while ($validates) {
                ...
                foreach ($data as $key => $record) {
                    ...
                    if ('only' === $options['validate'] || 'first' === $options['validate']) {
                        $validating = true;
                        if ($options['atomic']) {
                ...
                switch (true) {
                    case 'only' === $options['validate']:
                        return $options['atomic'] ? $validates : $return;
                    break;
                    case 'first' === $options['validate']:
        ...
        while ($validates) {
            ...
            $validating = ('only' === $options['validate'] || 'first' === $options['validate']);
                ...
                if (isset($associations[$association])) {
                    ...
                    switch ($type) {
                        ...
                        case 'hasMany':
                            ...
                            $_options = array_merge($options, ['atomic' => false]);

                            if ('first' === $_options['validate']) {
                                $_options['validate'] = 'only';
                            }
                            $_return = $this->{$association}->saveAll($values, $_options);

                            if (false === $_return || (is_array($_return) && in_array(false, $_return, true))) {
                                $validationErrors[$association] = $this->{$association}->validationErrors;
                                $validates = false;
                            }
                            if (is_array($_return)) {
     ...
     * @see Model::saveAll()
     */
    public function __save($data, $options)
    {
        if ('first' === $options['validate'] || 'only' === $options['validate']) {
            if (!($this->create($data) && $this->validates($options))) {
                return false;
            }
        } elseif (!(null !== $this->create(null) && $this->save($data, $options))) {
            return false;
        }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#delete
     */
    public function delete($id = null, $cascade = true)
    {
        ...
        if ($this->beforeDelete($cascade)) {
            $filters = $this->Behaviors->trigger($this, 'beforeDelete', [$cascade], [
                'break' => true, 'breakOn' => false,
            ]);
            ...
            if ($db->delete($this, [$this->alias.'.'.$this->primaryKey => $id])) {
                if (!empty($this->belongsTo)) {
     ...
     * @param bool   $cascade Set to true to delete records that depend on this record
     */
    public function _deleteDependent($id, $cascade)
    {
        ...
        if (true === $cascade) {
            foreach (array_merge($this->hasMany, $this->hasOne) as $assoc => $data) {
                if (true === $data['dependent']) {
                    $model = &$this->{$assoc};
                    if (false === $data['foreignKey'] && $data['conditions'] && in_array($this->name, $model->getAssociated('belongsTo'))) {
                        $model->recursive = 0;
     ...
     * @param string $id ID of record that was deleted
     */
    public function _deleteLinks($id)
    {
        foreach ($this->hasAndBelongsToMany as $assoc => $data) {
            $joinModel = $data['with'];
            $records = $this->{$joinModel}->find('all', [
                'conditions' => array_merge([$this->{$joinModel}->escapeField($data['foreignKey']) => $id]),
     ...
     * @return bool True on success, false on failure
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#deleteAll
     */
     ...
     * @return array
     */
    public function __collectForeignKeys($type = 'belongsTo')
    {
        $result = [];
    ...
    public function exists()
    {
        ...
        $conditions = [$this->alias.'.'.$this->primaryKey => $this->getID()];
        $query = ['conditions' => $conditions, 'recursive' => -1, 'callbacks' => false];
    ...
    {
        return false != $this->find('count', ['conditions' => $conditions, 'recursive' => -1]);
    }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#find
     */
    public function find($conditions = null, $fields = [], $order = null, $recursive = null)
    {
        if (!is_string($conditions) || (is_string($conditions) && !array_key_exists($conditions, $this->_findMethods))) {
            $type = 'first';
            $query = array_merge(compact('conditions', 'fields', 'order', 'recursive'), ['limit' => 1]);
        } else {
            list($type, $query) = [$conditions, $fields];
        }
        ...
        if ('all' != $type) {
            if (true === $this->_findMethods[$type]) {
        ...
        if (null === $query['order'] && null !== $this->order) {
            $query['order'] = $this->order;
        }
        $query['order'] = [$query['order']];

        if (true === $query['callbacks'] || 'before' === $query['callbacks']) {
            $return = $this->Behaviors->trigger($this, 'beforeFind', [$query], [
        ...
        if (true === $query['callbacks'] || 'after' === $query['callbacks']) {
     ...
     * @see Model::find()
     */
    public function _findFirst($state, $query, $results = [])
    {
        if ('before' == $state) {
            $query['limit'] = 1;
     ...
     * @see Model::find()
     */
    public function _findCount($state, $query, $results = [])
    {
        if ('before' == $state) {
            $db = &ConnectionManager::getDataSource($this->useDbConfig);
     ...
     * @see Model::find()
     */
    public function _findList($state, $query, $results = [])
    {
        if ('before' == $state) {
            if (empty($query['fields'])) {
            ...
            if (!isset($query['recursive']) || null === $query['recursive']) {
                $query['recursive'] = -1;
            }
     ...
     * @return array
     */
    public function _findNeighbors($state, $query, $results = [])
    {
        if ('before' == $state) {
            $query = array_merge(['recursive' => 0], $query);
            extract($query);
            ...
            } elseif (1 == count($return2) && !$return['prev']) {
     ...
     */
    public function _findThreaded($state, $query, $results = [])
    {
        if ('before' == $state) {
            return $query;
        } elseif ('after' == $state) {
            ...
            foreach ($results as $result) {
                ...
                if (isset($idMap[$id]['children'])) {
                    ...
                    $idMap[$id] = array_merge($result, ['children' => []]);
                }
     ...
     */
    public function __filterResults($results, $primary = true)
    {
        $return = $this->Behaviors->trigger($this, 'afterFind', [$results, $primary], ['modParams' => true]);
        if (true !== $return) {
            $results = $return;
        }
    ...
    public function isUnique($fields, $or = true)
    {
        ...
        return 0 == $this->find('count', ['conditions' => $fields, 'recursive' => -1]);
    }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#query
     */
    ...
    public function invalidFields($options = [])
    {
        if (
            ...
            false === $this->beforeValidate($options)
        ) {
            return false;
        }
        ...
        foreach ($this->validate as $fieldName => $ruleSet) {
            ...
            foreach ($ruleSet as $index => $validator) {
                ...
                if (!empty($validator['on'])) {
                    ...
                    if (('create' == $validator['on'] && $exists) || ('update' == $validator['on'] && !$exists)) {
                        continue;
                    }
                }

                $required = (
                    (!isset($data[$fieldName]) && true === $validator['required']) ||
                    (
                        isset($data[$fieldName]) && (empty($data[$fieldName]) &&
                        !is_numeric($data[$fieldName])) && false === $validator['allowEmpty']
                    )
                );
                ...
                if ($required) {
                    ...
                    if (empty($data[$fieldName]) && '0' != $data[$fieldName] && true === $validator['allowEmpty']) {
                        break;
                    }
     ...
     * @see Model::validates()
     */
    public function __validateWithModels($options)
    {
        $valid = true;
    ...
    public function escapeField($field = null, $alias = null)
    {
        ...
        $db = &ConnectionManager::getDataSource($this->useDbConfig);
        if (0 === strpos($field, $db->name($alias).'.')) {
            return $field;
        }
    ...
    public function setDataSource($dataSource = null)
    {
        ...
        if (empty($db) || !is_object($db)) {
            return $this->cakeError('missingConnection', [['code' => 500, 'className' => $this->alias]]);
        }
    }
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#beforeFind-1049
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#afterFind-1050
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#beforeSave-1052
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#afterSave-1053
     */
     ...
     * @return bool True if the operation should continue, false if it should abort
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#beforeDelete-1054
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#afterDelete-1055
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#beforeValidate-1051
     */
     ...
     *
     * @see http://book.cakephp.org/1.3/en/The-Manual/Developing-with-CakePHP/Models.html#Callback-Methods#onError-1056
     */
    ...
    {
        if (null === $type) {
            if (true === Configure::read('Cache.check')) {
