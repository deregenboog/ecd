...
?>	 
<i>IZ klanten worden automatisch toegevoegd aan de ErOpUit-kalender </i>
...
Vul 'nee' in als de klant geen gebruik wenst te maken van deze mogelijkheden, of deze al gebruikt.
	</p>
