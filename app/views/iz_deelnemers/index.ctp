...
<?php 
	if ($persoon_model == 'Klant') {
		echo $html->link('Nieuwe klant', array('controller' => 'klanten', 'action' => 'add', 'generic' => true), array(),
		...
		echo $html->link('Nieuwe vrijwilliger', array('controller' => 'vrijwilligers', 'action' => 'add', 'generic' => true), array(),
			__('Hebt u de algemene vrijwilligerlijst al gechecked? Weet u zeker dat dit een nieuwe vrijwilliger is?', true));
	}
	echo "<br/>";
