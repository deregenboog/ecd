...
<fieldset class="data" id="afsluiting" style="display: block;">
	<h2>Afsluiting</h2>
<?php
	if ($persoon_model == 'Klant' && $eropuit) {
...
?>
		<font color='red'>Let op, deze persoon is lid van de groep "ErOpUit Kalender". Bij afsluiting IZ moet dat lidmaatschap wellicht opgegezeg word <a href="<?= $url ?>">(klik hier)</a></font>
<?php
	}
?>
