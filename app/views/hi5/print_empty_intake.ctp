...
<?php
	...
	echo $format->printEmptyTableLine('Verblijfstatus',$verblijfstatussen,FormatHelper::UL_LIST_RADIO);
...
<?php
	...
	echo $format->printEmptyTableLine('Primaire problematiek',$problems,FormatHelper::UL_LIST_RADIO);
	
	echo $format->printEmptyTableLine('Verslavingsfrequentie',$verslavingsfrequenties,FormatHelper::UL_LIST_RADIO);
	
	echo $format->printEmptyTableLine('Verslavingsperiode',$verslavingsperiodes,FormatHelper::UL_LIST_RADIO);

	echo $format->printEmptyTableLine('Hoe gebruikt client?',$verslavingsgebruikswijzen,FormatHelper::UL_LIST_CHECKBOXES);
?>
			</table>
