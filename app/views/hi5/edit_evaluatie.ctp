...
<?php
	...
	echo $form->hidden('Hi5Evaluatie.id', array('value' => $klant['Klant']['id']));
...
<?php 
	...
	echo $date->input('Hi5Evaluatie.startdatumtraject', $today,	array(
...
<?php 
	...
	echo $date->input('Hi5Evaluatie.verslagvan', $today,array(
	...
	echo $date->input('Hi5Evaluatie.verslagtm', $today,	array(
		'label' => 't/m',
		'rangeLow' => (date('Y') - 1).date('-m-d'),
		'required' => true,
		'rangeHigh' => $today,
...
<?php
	...
	echo $form->input('extraanwezigen',	array('label' => 'Extra aanwezigen bij het gesprek'));
...
<?php
	...
	echo $form->input("Hi5EvaluatieQuestion.$questionId.hi5er_radio",
		array(
			...
			'after' => 'goed',
			'default' => 3,
			'value' => isset($selected[$questionId]) ? $selected[$questionId]['hi5er_radio'] : '',
			'legend' => false,
			'label' => false,
...
?>
					...
					<td>
<?php
	echo $form->input("Hi5EvaluatieQuestion.$questionId.wb_radio", array(
		'type'=> 'radio',
		'before' => 'slecht',
		'after' => 'goed',
		'default' => 3,
		'value' => isset($selected[$questionId]) ? $selected[$questionId]['wb_radio'] : '',
		'legend' => false,
		'label' => false,
		'options' => $radioOptions,
	));
