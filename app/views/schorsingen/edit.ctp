...
<?php
	...
	echo $form->label('nothing_at_all', _('Is de agressie gericht op een medewerker, stagair of vrijwilliger?'));
	...
	echo '<b>'._('Indien ja op wie is de agressie gericht?').'<font color="red">*</font></b>';
	echo "<fieldset>";
	echo "<table>";
	echo "<tr><td>".$this->Form->input('aggressie_doelwit', array('type' => 'text', 'legend' => false, 'fieldset' => false, 'label' => _('Betrokkene')))."</td>";
	...
	echo "<fieldset>";
	echo "<table>";
	echo "<tr><td>".$this->Form->input('aggressie_doelwit2', array('type' => 'text', 'legend' => false, 'fieldset' => false, 'label' => _('Betrokkene')))."</td>";
	...
	echo "<fieldset>";
	echo "<table>";
	echo "<tr><td>".$this->Form->input('aggressie_doelwit3', array('type' => 'text', 'legend' => false, 'fieldset' => false, 'label' => _('Betrokkene')))."</td>";
	...
	echo "<fieldset>";
	echo "<table>";
	echo "<tr><td>".$this->Form->input('aggressie_doelwit4', array('type' => 'text', 'legend' => false, 'fieldset' => false, 'label' => _('Betrokkene')))."</td>";
	...
	echo $form->label('nothing_at_all', _('Is er aangifte gedaan?'));
	echo $this->Form->input('aangifte', array('type' => 'radio', 'options' => $options, 'legend' => false, 'fieldset' => false));
	echo $form->label('nothing_at_all', _('Is er nazorg nodig?'));
