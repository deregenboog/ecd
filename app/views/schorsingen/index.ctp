...
<?php
	...
	echo $html->link('Schorsing toevoegen', $add_url);
?>
...
<p>
<?php 
	foreach ($active_schorsingen as $schorsing) {
?>
<?php
...
<p>
	<?php 
		foreach ($expired_schorsingen as $schorsing) {
			
			echo '<div class="editWrenchFloat">';
