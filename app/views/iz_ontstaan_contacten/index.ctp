...
<div class="izOntstaanContacten ">
	<h2><?php __('Ontstaan contacten');?></h2>
	...
	<?php
	$i = 0;
	foreach ($izOntstaanContacten as $izOntstaanContact):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $izOntstaanContact['IzOntstaanContact']['id']; ?>&nbsp;</td>
		<td><?php echo $izOntstaanContact['IzOntstaanContact']['naam']; ?>&nbsp;</td>
		<td><?php echo $izOntstaanContact['IzOntstaanContact']['active']; ?>&nbsp;</td>
		<td class="actions">
			<?php
				$wrench = $html->image('wrench.png');
				$url = array('action' => 'edit', $izOntstaanContact['IzOntstaanContact']['id']);
