...
class TwigView_Filter_Time extends TwigView_Extension
{
     ...
     * @author Kjell Bublitz
     */
    public function timeAgoInWords($var, $options = [])
    {
     ...
     * @author Kjell Bublitz
     */
    public function toUnix($var, $userOffset = null)
    {
     ...
     * @author Kjell Bublitz
     */
    public function toRSS($var, $userOffset = null)
    {
     ...
     * @author Kjell Bublitz
     */
    public function toAtom($var, $userOffset = null)
    {
     ...
     * @author Kjell Bublitz
     */
    public function nice($var, $userOffset = null)
    {
     ...
     * @author Kjell Bublitz
     */
    public function niceShort($var, $userOffset = null)
    {
