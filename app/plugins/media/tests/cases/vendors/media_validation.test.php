...
class MediaValidationTest extends CakeTestCase
{
    ...
    public function testMimeType()
    {
        ...
        $check = 'image/png';
        $result = MediaValidation::mimeType($check, ['image/png']);
        $this->assertFalse($result);

        $check = 'image/png';
        $result = MediaValidation::mimeType($check, ['image/png'], ['image/png']);
        $this->assertFalse($result);
    ...
    public function testExtension()
    {
        ...
        $check = 'tar.gz';
        $result = MediaValidation::extension($check, false, ['tar', 'gz']);
        $this->assertTrue($result);
        ...
        $check = 'png';
        $result = MediaValidation::extension($check, ['png']);
        $this->assertFalse($result);

        $check = 'png';
        $result = MediaValidation::extension($check, ['png'], ['png']);
        $this->assertFalse($result);
        ...
        $deny = ['bin', 'class', 'dll', 'dms', 'exe', 'lha'];
        $allow = ['pdf'];
        $check = 'tmp';
    ...
    public function testLocation()
    {
        ...
        $result = MediaValidation::location(TMP, [DS]);
        $this->assertTrue($result);

        $result = MediaValidation::location(TMP.DS.DS.DS, [DS]);
        $this->assertTrue($result);

        $result = MediaValidation::location(TMP.DS.'file.png', [DS]);
        $this->assertTrue($result);

        $result = MediaValidation::location(TMP, [TMP.'subdir']);
        $this->assertFalse($result);
        ...
        $result = MediaValidation::location('http://cakeforge.org', [TMP]);
        $this->assertFalse($result);

        $result = MediaValidation::location('http://cakeforge.org', [TMP, 'http://']);
        $this->assertTrue($result);
