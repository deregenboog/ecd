 ...
 */
App::import('Vendor', 'Media.VideoMedium', ['file' => 'medium'.DS.'video.php']);
App::import('Vendor', 'FfMpegVideoMediumAdapter', ['file' => 'medium'.DS.'adapter'.DS.'ff_mpeg_video.php']);
...
class FfmpegVideoMediumAdapterTest extends CakeTestCase
{
    ...
    public function testInformationMp4tag()
    {
        $Medium = new TestFfmpegVideoMedium($this->TestData->getFile('video-quicktime.notag.mov'));
    ...
    public function testInformationMp4notag()
    {
        $Medium = new TestFfmpegVideoMedium($this->TestData->getFile('video-quicktime.notag.mov'));
    ...
    public function testInformationTheoraComment()
    {
    ...
    public function testInformationTheoraNotag()
    {
    ...
    public function testConvertTheora()
    {
        $Medium = new TestFfmpegVideoMedium($this->TestData->getFile('video-theora.comments.ogv'));
