...
class MediaBehavior extends ModelBehavior
{
    ...
    {
        //////////
        //this tried to convert a pdf to an image and resize it!
        //if(!preg_match('/.pdf$/',$Model->data['Attachment']['basename'])){
     ...
     * @return bool
     */
    public function make(&$Model, $file, $overwrite = false)
    {
        extract($this->settings[$Model->alias]);
     ...
     * @return array
     */
    public function _file(&$Model, $file)
    {
        extract($this->settings[$Model->alias]);
