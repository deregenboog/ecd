 ...
 */
class Version20170907133213 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE clip_clienten (id INT AUTO_INCREMENT NOT NULL, klant_id INT NOT NULL, viacategorie_id INT NOT NULL, medewerker_id INT NOT NULL, aanmelddatum DATE NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, UNIQUE INDEX UNIQ_B7F4C67E3C427B2F (klant_id), INDEX IDX_B7F4C67EC5BB5F49 (viacategorie_id), INDEX IDX_B7F4C67E3D707F64 (medewerker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clip_contactmomenten (id INT AUTO_INCREMENT NOT NULL, vraag_id INT NOT NULL, medewerker_id INT NOT NULL, datum DATE NOT NULL, opmerking LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, INDEX IDX_8C4DFF3D2CE1D7E6 (vraag_id), INDEX IDX_8C4DFF3D3D707F64 (medewerker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clip_documenten (id INT AUTO_INCREMENT NOT NULL, medewerker_id INT NOT NULL, naam VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, INDEX IDX_98FCA3D707F64 (medewerker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE clip_behandelaars (id INT AUTO_INCREMENT NOT NULL, medewerker_id INT NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_4B016D223D707F64 (medewerker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE clip_clienten ADD CONSTRAINT FK_B7F4C67E3D707F64 FOREIGN KEY (medewerker_id) REFERENCES medewerkers (id)');
        ...
        $this->addSql('ALTER TABLE clip_vragen ADD CONSTRAINT FK_C28C59173D707F64 FOREIGN KEY (medewerker_id) REFERENCES medewerkers (id)');
        ...
        $this->addSql('ALTER TABLE clip_contactmomenten ADD CONSTRAINT FK_8C4DFF3D3D707F64 FOREIGN KEY (medewerker_id) REFERENCES medewerkers (id)');
        $this->addSql('ALTER TABLE clip_documenten ADD CONSTRAINT FK_98FCA3D707F64 FOREIGN KEY (medewerker_id) REFERENCES medewerkers (id)');
