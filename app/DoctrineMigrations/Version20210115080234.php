...
final class Version20210115080234 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mw_deelnames (id INT AUTO_INCREMENT NOT NULL, inloop_vrijwilliger_id INT NOT NULL, overig VARCHAR(255) DEFAULT NULL, datum DATE DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, inloopTraining_id INT NOT NULL, INDEX IDX_59035D7541D2A6EF (inloopTraining_id), INDEX IDX_59035D75B280D297 (inloop_vrijwilliger_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE mw_deelnames ADD CONSTRAINT FK_59035D7541D2A6EF FOREIGN KEY (inloopTraining_id) REFERENCES inloop_training (id)');
        $this->addSql('ALTER TABLE mw_deelnames ADD CONSTRAINT FK_59035D75B280D297 FOREIGN KEY (inloop_vrijwilliger_id) REFERENCES mw_vrijwilligers (id)');
        ...
        $this->addSql('ALTER TABLE mw_vrijwilliger_memo ADD CONSTRAINT FK_516FADD2B4D32439 FOREIGN KEY (memo_id) REFERENCES inloop_memos (id)');
...
INSERT IGNORE INTO `mw_training` (`id`, `naam`, `active`) VALUES(3, 'Overig', 1)");
        ...
        $this->addSql('ALTER TABLE mw_deelnames CHANGE inlooptraining_id mwTraining_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mw_deelnames CHANGE mwtraining_id inloopTraining_id INT NOT NULL');
        $this->addSql('ALTER TABLE mw_deelnames ADD CONSTRAINT FK_59035D7541D2A6EF FOREIGN KEY (inloopTraining_id) REFERENCES inloop_training (id)');
        $this->addSql('CREATE INDEX IDX_59035D7541D2A6EF ON mw_deelnames (inloopTraining_id)');
