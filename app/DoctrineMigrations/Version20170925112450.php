 ...
 */
class Version20170925112450 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE hs_herinneringen (id INT AUTO_INCREMENT NOT NULL, factuur_id INT DEFAULT NULL, datum DATE NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_D18DFCA3C35D3E (factuur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hs_klanten (id INT AUTO_INCREMENT NOT NULL, geslacht_id INT NOT NULL, medewerker_id INT NOT NULL, erp_id INT DEFAULT NULL, bsn VARCHAR(255) DEFAULT NULL, rekeningnummer VARCHAR(255) DEFAULT NULL, werkgebied VARCHAR(255) DEFAULT NULL, inschrijving DATE NOT NULL, uitschrijving DATE DEFAULT NULL, laatsteContact DATE DEFAULT NULL, actief TINYINT(1) NOT NULL, onHold TINYINT(1) NOT NULL, bewindvoerder LONGTEXT DEFAULT NULL, saldo NUMERIC(10, 2) NOT NULL, voornaam VARCHAR(255) DEFAULT NULL, roepnaam VARCHAR(255) DEFAULT NULL, tussenvoegsel VARCHAR(255) DEFAULT NULL, achternaam VARCHAR(255) NOT NULL, adres VARCHAR(255) DEFAULT NULL, postcode VARCHAR(255) DEFAULT NULL, plaats VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, mobiel VARCHAR(255) DEFAULT NULL, telefoon VARCHAR(255) DEFAULT NULL, hulpverlener_naam VARCHAR(255) DEFAULT NULL, hulpverlener_organisatie VARCHAR(255) DEFAULT NULL, hulpverlener_telefoon VARCHAR(255) DEFAULT NULL, hulpverlener_email VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, INDEX IDX_CC6284A1C729A47 (geslacht_id), INDEX IDX_CC6284A3D707F64 (medewerker_id), UNIQUE INDEX unique_erp_id_idx (erp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hs_vrijwilligers (id INT NOT NULL, vrijwilliger_id INT NOT NULL, hulpverlener_naam VARCHAR(255) DEFAULT NULL, hulpverlener_organisatie VARCHAR(255) DEFAULT NULL, hulpverlener_telefoon VARCHAR(255) DEFAULT NULL, hulpverlener_email VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_3FE7029676B43BDC (vrijwilliger_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hs_dienstverleners (id INT NOT NULL, klant_id INT NOT NULL, hulpverlener_naam VARCHAR(255) DEFAULT NULL, hulpverlener_organisatie VARCHAR(255) DEFAULT NULL, hulpverlener_telefoon VARCHAR(255) DEFAULT NULL, hulpverlener_email VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_4949548D3C427B2F (klant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE hs_klussen (id INT AUTO_INCREMENT NOT NULL, klant_id INT DEFAULT NULL, activiteit_id INT NOT NULL, medewerker_id INT NOT NULL, startdatum DATE NOT NULL, einddatum DATE DEFAULT NULL, onHold TINYINT(1) NOT NULL, INDEX IDX_3E9A80CF3C427B2F (klant_id), INDEX IDX_3E9A80CF5A8A0A1 (activiteit_id), INDEX IDX_3E9A80CF3D707F64 (medewerker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE hs_herinneringen ADD CONSTRAINT FK_D18DFCA3C35D3E FOREIGN KEY (factuur_id) REFERENCES hs_facturen (id)');
