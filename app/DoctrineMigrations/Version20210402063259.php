...
final class Version20210402063259 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("ALTER TABLE `ecd`.`registraties_recent` DROP FOREIGN KEY `FK_B1AD39F05CD9765E`;ALTER TABLE `registraties_recent` ADD CONSTRAINT `FK_B1AD39F05CD9765E` FOREIGN KEY (`registratie_id`) REFERENCES `registraties`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;");
