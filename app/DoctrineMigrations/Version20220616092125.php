...
final class Version20220616092125 extends AbstractMigration
{
      public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE oekraine_bezoekers (id INT AUTO_INCREMENT NOT NULL, intake_id INT DEFAULT NULL, created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, modified DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, appKlant_id INT NOT NULL, dossierStatus_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_7027BCA15C217849 (appKlant_id), UNIQUE INDEX UNIQ_7027BCA1EF862509 (dossierStatus_id), UNIQUE INDEX UNIQ_7027BCA1733DE450 (intake_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
