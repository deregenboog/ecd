 ...
 */
class Version20170529073058 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE inloop_dossier_statussen (id INT AUTO_INCREMENT NOT NULL, klant_id INT NOT NULL, medewerker_id INT NULL, reden_id INT NULL, datum DATE NOT NULL, toelichting LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, class VARCHAR(255) NOT NULL, INDEX IDX_12D2B5703C427B2F (klant_id), INDEX IDX_12D2B5703D707F64 (medewerker_id), INDEX IDX_12D2B570D29703A5 (reden_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inloop_afsluiting_redenen (id INT AUTO_INCREMENT NOT NULL, naam VARCHAR(255) NOT NULL, actief TINYINT(1) NOT NULL, gewicht INT NOT NULL DEFAULT 0, created DATETIME NOT NULL, modified DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
