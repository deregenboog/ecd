...
class Version20170410121504 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE nationaliteiten SET naam = 'de Bondsrepubliek Duitsland (burger van)' WHERE naam = 'Burger van de Bondsrepubliek Duitsland'");
        ...
        $this->addSql("UPDATE nationaliteiten SET naam = 'Oekraine (burger van)' WHERE naam = 'Burger van Oekraine'");
        $this->addSql("UPDATE nationaliteiten SET naam = 'Rusland (burger van)' WHERE naam = 'Burger van Rusland'");
        $this->addSql("UPDATE nationaliteiten SET naam = 'Servië (burger van)' WHERE naam = 'Burger van Servië'");
        $this->addSql("UPDATE nationaliteiten SET naam = 'Slovenië (burger van)' WHERE naam = 'Burger van Slovenië'");
