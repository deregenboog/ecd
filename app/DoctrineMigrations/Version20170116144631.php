...
class Version20170116144631 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE oek_klanten (id INT AUTO_INCREMENT NOT NULL, klant_id INT NOT NULL, aanmelding DATE NOT NULL, verwijzing_door VARCHAR(255) NOT NULL, afsluiting DATE DEFAULT NULL, verwijzing_naar VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, UNIQUE INDEX UNIQ_A501F8F73C427B2F (klant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
