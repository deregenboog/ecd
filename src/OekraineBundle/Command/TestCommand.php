...
class TestCommand extends ContainerAwareCommand
{
    ...
    {
        $klantDao = $this->getContainer()->get('OekraineBundle\Service\BezoekerDao');
        $locatieDao = $this->getContainer()->get('OekraineBundle\Service\LocatieDao');

        $locaties = $locatieDao->findAll();

//         $locaties = [$locatieDao->find(21)];
//         $klanten = [$bezoekerDao->find(5612462)];
