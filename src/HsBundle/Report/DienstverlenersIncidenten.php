...
class DienstverlenersIncidenten extends AbstractReport
{
    protected $title = 'Dienstverleners incidenten';
    ...
    {
        $builder = $this->entityManager->getRepository(DienstverlenersIncident::class)->createQueryBuilder('incident')
