...
class KoppelingenPerGgwGebied extends AbstractReport
{
    /**
    ...
    protected $title = 'Koppelingen per GGW-gebied';
    ...
    {
        $this->data['dienstverlener'] = $this->dao->countDienstverlenersByGgwGebied($this->startDate, $this->endDate);
        $this->data['vrijwilliger'] = $this->dao->countVrijwilligersByGgwGebied($this->startDate, $this->endDate);
