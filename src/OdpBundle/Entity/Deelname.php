...
class Deelname
{
     ...
     * @var Training
     *
     * @ORM\ManyToOne(targetEntity="OdpBundle\Entity\Training", cascade={"persist"}, inversedBy="deelnames")
     ...
     * @ORM\JoinColumn(name="odp_vrijwilliger_id", nullable=false)
     * @Gedmo\Versioned
     */
