...
use OdpBundle\Form\AanmeldingType;
use OdpBundle\Form\AfsluitingType;
use InloopBundle\Form\KlantType;
use JMS\DiExtraBundle\Annotation as DI;
use OdpBundle\Entity\Document;
use OdpBundle\Entity\Info;
use OdpBundle\Form\InfoType;
use OdpBundle\Form\KlantFilterType;
...
class KlantenController extends AbstractController
{
    ...
    protected $baseRouteName = 'odp_klanten_';
    protected $searchFilterTypeClass = AppKlantFilterType::class;

    /**
     * @var KlantDaoInterface
     *
     * @DI\Inject("OdpBundle\Service\KlantDao")
     */
    protected $dao;
    ...
    public function closeAction(Request $request, $id)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('odp_klanten_index');
        }
