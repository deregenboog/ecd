...
class VrijwilligersPerProjectStadsdeelKlant extends AbstractVrijwilligersReport
{
    ...
    {
        $this->beginstand = $this->repository->countByProjectAndStadsdeelKlant(
            IzVrijwilligerRepository::REPORT_BEGINSTAND,
            $this->startDate,
            $this->endDate
        );
        $this->gestart = $this->repository->countByProjectAndStadsdeelKlant(
            IzVrijwilligerRepository::REPORT_GESTART,
            $this->startDate,
            $this->endDate
        );
        $this->nieuwGestart = $this->repository->countByProjectAndStadsdeelKlant(
            IzVrijwilligerRepository::REPORT_NIEUW_GESTART,
            $this->startDate,
            $this->endDate
        );
        $this->afgesloten = $this->repository->countByProjectAndStadsdeelKlant(
            IzVrijwilligerRepository::REPORT_AFGESLOTEN,
            $this->startDate,
            $this->endDate
        );
        $this->eindstand = $this->repository->countByProjectAndStadsdeelKlant(
