 ...
 * @Template
 */
class LogeerOpvangController extends AbstractController implements DossierStatusControllerInterface
{
    ...
    protected $baseRouteName = 'villa_logeeropvang_';
...
//    protected $addMethod = 'doAdd';
    ...
    protected function getDownloadFilename()
    {
        ...
        return sprintf('villa-logeerophang-%s.xlsx', (new \DateTime())->format('d-m-Y'));
    }
